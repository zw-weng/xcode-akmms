...
if(isset($_POST['saveuser'])){
    ...
    if($fname != '' || $fphone != '' || $femail != '' || $fstreet != '' || $fpostcode != '' || $fcity != '' || $fstate != '' || $fcountry != ''){
        ...
        if (!filter_var($femail, FILTER_VALIDATE_EMAIL)) {
            redirect('staff-customeradd1.php', 'Invalid email format');
        }
        ...
        if ($stmt) {
            ...
            if($result){
                redirect('staff-customer1.php', 'New customer added successfully');
            } else {
                redirect('staff-customer1.php', 'Something went wrong');
            }
            ...
            redirect('staff-customer1.php', 'Error preparing statement');
        }
    } else {
        redirect('staff-customeradd1.php', 'Please fill all the input fields');
    }
}
...
header('Location:staff-customer1.php');
