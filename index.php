                  ...
                  <form class="row g-3 needs-validation" method="post" action="loginprocess.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="text" name="fid" class="form-control" id="yourUsername" placeholder="Your user ID" required>
                    ...
                    <div class="col-12">
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <p class="small mb-0"><a href="password-reset.php" class="btn-link">Forgot password?</a></p>
                      </div>
                      <div class="input-group">
                        <input type="password" name="fpwd" class="form-control" id="yourPassword" placeholder="Your password" required>
