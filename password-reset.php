                  ...
                  <form class="row g-3 needs-validation" method="POST" action="password-resetprocess.php">
                    ...
                    <div class="col-12">
                      <div class="d-flex justify-content-between align-items-center">
                        ...
                        <p class="small mb-0"><a class="btn-link" href="index.php">Sign in?</a></p>
                      </div>
                      <div class="input-group has-validation">
                        <input type="email" name="femail" class="form-control" id="yourEmail" placeholder="example@gmail.com" required>
                        <div class="invalid-feedback">Please enter your email.</div>
                      </div>
                    </div>

                    <div class="col-12">
                      <button class="btn btn-primary w-100" name="forgotBtn" type="submit">Submit</button>
                    </div>
                  </form>
                </div>
              </div>
