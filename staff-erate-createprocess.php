...
if(isset($_POST['save_e'])){
    ...
    if($state != '' || $district != '' || $group_range != '' || $erate != ''){
        ...
        if ($stmt) {
            ...
            if($result){
                redirect('staff-jkr.php', 'New electric rate charged added successfully');
            } else {
                redirect('staff-erate-create.php', 'Something went wrong');
            }
            ...
            redirect('staff-erate-create.php', 'Error preparing statement');
        }
    } else {
        redirect('staff-erate-create.php', 'Please fill all the input fields');
    }
}
