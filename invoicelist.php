...
";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<a href='invoiceupdate.php?quotation_id={$row['quotation_id']}' class='btn btn-warning btn-sm' title='Edit'><i class='bi bi-pencil'></i></a>";
                                            echo "&nbsp;";
                                            echo "<a href='invoicegenerate.php?quotation_id={$row['quotation_id']}' class='btn btn-danger btn-sm' title='Generate PDF'><i class='bi bi-file-pdf'></i></a>";
                                            echo "&nbsp;";
