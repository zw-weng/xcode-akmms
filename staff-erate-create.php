            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="staff-erate-createprocess.php">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="erate" class="form-control" id="erate" placeholder="Enter rate to be charged with up to 2 decimal places" step="0.01" required>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" name="save_e" class="btn btn-outline-primary"><i class="bi bi-arrow-up-square"></i> Save</button>
                                &nbsp;
