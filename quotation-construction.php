    ...
    <div class="pagetitle">
      ...
      <nav>
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Quotation (Construction)</li>
          </ol>
      </nav>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form method="POST" action="quotation-constructionprocess.php">
                   <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Quotation ID</label>
                    <input type="text" name="quotation_id" class="form-control" id="exampleInputPassword1" placeholder="Quotation ID here" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Customer ID</label>
                    <input type="text" name="cust_id" class="form-control" id="exampleInputPassword1" placeholder="Customer ID here" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Client Name</label>
                    <input type="text" name="client_name" class="form-control" id="exampleInputPassword1" placeholder="Client Name here" autocomplete="off" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Item ID</label>
                    <input type="text" name="item_id" class="form-control" id="exampleInputPassword1" placeholder="Enter Item ID" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputEmail1" class="form-label mt-4">Material ID</label>
                    <input type="text" name="material_id" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Material ID" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Quantity</label>
                    <input type="text" name="quantity" class="form-control" id="exampleInputPassword1" placeholder="Quantity here" required>
                  </div>
                  
                  <div class="form-group">
                    <label for="exampleTextarea" class="form-label mt-4">Address</label>
                    <textarea class="form-control" name="client_add" id="exampleTextarea" placeholder="Client Address here" rows="3" required></textarea>
                  </div>
              </div>
