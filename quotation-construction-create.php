    ...
    <div class="pagetitle">
      ...
      <nav>
          <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="quotation-construction.php">Construction</a></li>
              ...
              <form method="POST" action="user-createprocess.php">
                  ...
                  <div class="form-group row">
                      <div class="col-md-6">
                          ...
                          <input type="text" name="price" class="form-control" id="ffname" placeholder="" required>
                      </div>
                      <div class="col-md-6">
                          <label for="flname" class="form-label mt-4">Sub Total</label>
                          <input type="text" name="subtotal" class="form-control" id="flname" placeholder="" required>
                      </div>
                  </div>
