                  ...
                  <form class="row g-3 needs-validation" method="POST" action="password-resetprocess.php">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        <input type="email" name="email" value="<?php if(isset($_GET['email'])){echo $_GET['email'];} ?>" class="form-control" id="yourEmail" placeholder="example@gmail.com" required>
                      </div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">New Password</label>
                      <input type="password" name="newpwd" class="form-control" id="yourPassword" placeholder="password" required>
                      <div class="invalid-feedback">Please enter new password!</div>
                    </div>

                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Confirm Password</label>
                      <input type="password" name="confirmpwd" class="form-control" id="yourPassword" placeholder="password" required>
