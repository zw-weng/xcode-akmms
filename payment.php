    ...
    <div class="pagetitle">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group me-2">
                <a href="payment-create.php" class="btn btn-primary shadow"><i class="bi bi-plus-circle"></i> Add</a>
                <a href="payment-export-excel.php" class="btn btn-success shadow"><i class="bi bi-file-excel"></i> Export</a>
        <a href="payment-bin.php" class="btn btn-secondary shadow">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        if ($row['payment_status'] == 1) {
                                            ...
                                            echo "&nbsp;";
                                            echo "<a href='payment-edit.php?id=" . $row['payment_id'] . "' class='btn btn-warning btn-sm'><i class='bi bi-pencil'></i></a>";
                                            echo "&nbsp;";
                                            echo "<a class='btn btn-danger btn-sm' href='payment-deactivate.php?id=" . $row['payment_id'] . "&action=deactivate' onclick='return confirm(\"Are you sure you want to delete this payment?\")'><i class='bi bi-trash'></i></a>";
                                            echo "</div>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
