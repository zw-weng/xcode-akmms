                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" method="post" action="loginprocess.php">
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="fpwd" class="form-control" id="yourPassword" placeholder="password" required>
                      <div class="invalid-feedback">Please enter your password!</div>
                    </div>

                    <div class="col-12">
                      <p class="small mb-0"><a href="password-reset.php">Forgot password?</a></p>
                    </div>
