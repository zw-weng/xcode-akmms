    ...
    <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="btn-group">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="quote-ads-create.php"><i class="bi bi-play-fill"></i> Advertising</a>
          <a class="dropdown-item" href="quote-jkr-create.php"><i class="bi bi-cone-striped"></i> Construction</a>
        </div>
      </div>
    </div>
  </div><!-- End Page Title -->
...
INNER JOIN 
    ...
    echo "<a href='update-status.php?quotation_id={$row['quotation_id']}&status_id={$status_id}' class='btn btn-primary btn-sm' title='Approve'><div class='icon'><i class='bi bi-check2-square'></i></div></a>";
}
                        echo "</div>";
                        echo "</td>";
                        echo "</tr>";
