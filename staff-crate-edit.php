...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM tb_civil WHERE c_id = ?";
    $stmt = mysqli_prepare($con, $sql);

    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "s", $crateId);
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="staff-crate-editprocess.php?id=<?= $row['c_id'] ?>" enctype="multipart/form-data">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <select name="state" class="form-control" id="state" required>
                                        ...
                                        foreach ($states as $state) {
                                            $selected = ($state == $row['c_state']) ? 'selected' : '';
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="district" class="form-control" id="district" required>
                                        ...
                                        $selectedState = $row['c_state'];
                                        $selectedDistrict = $row['c_district'];
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="group_range" class="form-control" id="group_range" value="<?= $row['c_group'] ?>" required>
                                    <small class="text-muted">Eg. kurang dari 16km</small>
                                </div>
                                <div class="col-md-6">
                                    <label for="crate" class="form-label mt-4">Rate (%)</label>
                                    <input type="number" name="crate" class="form-control" id="crate" value="<?= $row['c_rate'] ?>" step="0.01" required>
                            ...
                            <button type="submit" name="update_c" class="btn btn-outline-primary"><i class="bi bi-arrow-up-square"></i> Save</button>
                                &nbsp;
