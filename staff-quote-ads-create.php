...
$sql = "SELECT * FROM tb_quotation 
        INNER JOIN tb_paymentterm ON tb_quotation.payment_term_id = tb_paymentterm.payment_term_id";
...
<main id="main" class="main">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="staff-quote.php">Quotation</a></li>
    ...
    <section class="section">
        <form method="POST" action="staff-quote-ads-createprocess.php">
            <div class="row">
                <?= alertMessage(); ?>
                <div class="col-lg-6">
                    <div class="card">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="staff-quote-jkr-add.php" class="btn btn-primary shadow" data-bs-toggle="modal" data-bs-target="#adsModal">
