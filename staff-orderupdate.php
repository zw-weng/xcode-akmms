        ...
        <div class="d-flex justify-content-between align-items-center">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="staff-order.php">Order</a></li>
                    <li class="breadcrumb-item active">Update Order</li>
                </ol>
            </nav>
            <div class="btn-group me-2">
                <a href="staff-order.php" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="staff-orderupdateprocess.php" method="post">
