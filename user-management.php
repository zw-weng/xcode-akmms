              ...
              <div class="modal-body">
                <form method="POST" action="registerprocess.php">
                  <div class="form-group">
                    ...
                    <input type="text" name="fic" class="form-control" id="exampleInputPassword1" placeholder="IC number without dash (-)" required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1" class="form-label mt-4">Full Name</label>
                    <input type="text" name="fname" class="form-control" id="exampleInputPassword1" placeholder="Name according to IC" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="flic" class="form-control" id="exampleInputPassword1" placeholder="Driving license number" required>
                  </div>
