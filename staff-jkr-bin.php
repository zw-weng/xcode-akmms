                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        if ($row['material_status'] == 0) {
                                            ...
                                            echo "<a class='btn btn-success btn-sm' href='staff-jkr-activate.php?id=" . $row['material_id'] . "&action=activate' onclick='return confirm(\"Are you sure you want to restore this material?\")'><i class='bi bi-arrow-counterclockwise'></i> Restore</a>";
                                            echo "</div>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
