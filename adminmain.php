...
<main id="main" class="main">
  ...
  <div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Reporting Dashboard</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
  ...
  <section class="section dashboard">
        ...
        <div class="card info-card revenue-card">
          ...
          <div class="filter">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              ...
              <li><a class="dropdown-item" href="salesreportgeneration.php">Generate Sales Report</a></li>
            </ul>
          </div>
          ...
          <div class="card-body">
            ...
            <div class="d-flex align-items-center">
              ...
              <div class="ps-3">
                <h6><?php echo 'RM' . $formattedNetProfit ?></h6>
        ...
        <div class="card info-card sales-card">
          ...
          <div class="filter">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              ...
              <li><a class="dropdown-item" href="stockpdf.php">Generate Stock Report</a></li>
            </ul>
          </div>
        ...
        <div class="card info-card revenue-card">
          ...
          <div class="filter">
            ...
            <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              ...
              <li><a class="dropdown-item" href="reportgeneration.php">Generate Transaction Report</a></li>
            </ul>
          </div>
    ...
    <div class="card">
        <div class="card-body pb-0">
            <h5 class="card-title">User Status Chart <span>| All </span></h5>
            <div id="userTrafficChart" style="min-height: 300px;" class="echart"></div>

            <script>
                document.addEventListener("DOMContentLoaded", () => {
                    new echarts.init(document.querySelector("#userTrafficChart")).setOption({
                        tooltip: {
                            trigger: 'item'
                        },
                        legend: {
                        ...
                        series: [{
                            ...
                            data: [{
                                    value: <?php echo $rowi['rowCount6']; ?>,
                                    name: 'Previous User'
                                },
                                {
                                    value: <?php echo $rowh['rowCount5']; ?>,
                                    name: 'Current User'
                                }
                            ],
                            itemStyle: {
                                ...
                                normal: {
                                    color: function(params) {
                                        // Color mapping based on data index
                                        var colorList = ['#FF9999', '#66B2FF'];
