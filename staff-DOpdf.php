        ...
        <div class="d-flex justify-content-between align-items-center">
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="staff-deliveryorderlist.php">Delivery Order</a></li>
                    <li class="breadcrumb-item active">Generate Delivery Order</li>
                </ol>
            </nav>
            <div class="btn-group me-2">
                <a href="staff-deliveryorderlist.php" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back</a>
            </div>
        </div>
    </div><!-- End Page Title -->
