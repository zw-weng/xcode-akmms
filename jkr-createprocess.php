...
if(isset($_POST['save_jkr'])){
    ...
    if($material_name != '' || $material_desc != '' || $material_cost != '' || $material_unit != '' || $material_category != ''){
        ...
        if ($stmt) {
            ...
            if($result){
                redirect('jkr.php', 'New material added successfully');
            } else {
                redirect('jkr-create.php', 'Something went wrong');
            }
            ...
            redirect('jkr-create.php', 'Error preparing statement');
        }
    } else {
        redirect('jkr-create.php', 'Please fill all the input fields');
    }
}
