                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        if ($row['item_status'] == 0) {
                                            ...
                                            echo "<a class='btn btn-success btn-sm' href='stock-activate.php?id=" . $row['item_id'] . "&action=activate' onclick='return confirm(\"Are you sure you want to restore this item?\")'><i class='bi bi-arrow-counterclockwise'></i> Restore</a>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
                                    }
