...
if (isset($_GET['id']) && $_GET['action'] == 'activate') {
    ...
    if ($stmtUpdateStatus) {
        ...
        if (mysqli_stmt_execute($stmtUpdateStatus)) {
            ...
            if (mysqli_stmt_affected_rows($stmtUpdateStatus) > 0) {
                ...
                redirect('staff-customer1.php', 'Customer<strong> ' . $cust_id . ' </strong>is activated successfully');
                ...
                redirect('staff-customer1.php', 'No user found with the provided ID.');
    ...
    redirect('staff-customer1.php', 'Error in user activation.');
