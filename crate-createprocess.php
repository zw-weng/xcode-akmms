...
if(isset($_POST['save_c'])){
    ...
    if($state != '' || $district != '' || $group_range != '' || $crate != ''){
        ...
        if ($stmt) {
            ...
            if($result){
                redirect('jkr.php', 'New civil rate charged added successfully');
            } else {
                redirect('crate-create.php', 'Something went wrong');
            }
            ...
            redirect('crate-create.php', 'Error preparing statement');
        }
    } else {
        redirect('crate-create.php', 'Please fill all the input fields');
    }
}
