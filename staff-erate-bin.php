                ...
                <tbody>
                  ...
                  while ($rowe = mysqli_fetch_array($resulte)) {
                    if ($rowe['e_status'] == 0) {
                      ...
                      echo "<a class='btn btn-success btn-sm' href='staff-erate-activate.php?id=" . $rowe['e_id'] . "&action=activate' onclick='return confirm(\"Are you sure you want to restore this data?\")'><i class='bi bi-arrow-counterclockwise'></i> Restore</a>";
                      echo "</div>";
                      echo "</td>";
                      echo "</tr>";
                    }
