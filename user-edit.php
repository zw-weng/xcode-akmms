                        ...
                        <form method="POST" action="user-editprocess.php?id='.$row['user_id'].'">
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <?php
                                    echo '<input type="hidden" name="fid" class="form-control" value="' . $row['user_id'] . '" id="fid" placeholder="" required>';
                                    ?>
                                    <?php
                                    echo '<input type="text" name="fid1" class="form-control" value="' . $row['user_id'] . '" id="fid1" placeholder="" required disabled>';
                                    ?>
                                </div>
                                <div class="col-md-6">
