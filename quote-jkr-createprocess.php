...
if (isset($_POST['save_info'])) {
    ...
    if ($quotationId != '' || $quotationDate != '' || $paymentTerm != '' || $fname != '' || $femail != '' || $fphone != '' || $fstreet != '' || $fpostcode != '' || $fcity != '' || $fstate != '' || $fcount != '') {
        ...
        if ($checkCustomerStmt) {
            ...
            if (mysqli_stmt_num_rows($checkCustomerStmt) > 0) {
                ...
                if ($customerStmt) {
                    ...
                    if ($customerResult) {
                        ...
                        redirect('quote-jkr-create.php', 'Something went wrong with tb_customer insertion');
                    }
                    ...
                    redirect('quote-jkr-create.php', 'Error preparing tb_customer statement');
                }
            }
            ...
            // Prepare statement failed
            redirect('quote-jkr-create.php', 'Error preparing checkCustomer statement');
        }
        ...
        if ($quotationStmt) {
            ...
            if ($quotationResult) {
                ...
                for ($i = 0; $i < count($qty); $i++) {
                    ...
                    if ($productStmt) {
                        ...
                        if (!$productResult) {
                            redirect('quote-jkr-create.php', 'Something went wrong with tb_product insertion');
                        }
                        ...
                        // Prepare statement failed
                        redirect('quote-jkr-create.php', 'Error preparing tb_product statement');
                    }
                }

                // Redirect to the next step or perform other actions
                redirect('quote.php', 'Quotation created successfully');
            } else {
                redirect('quote-jkr-create.php', 'Something went wrong with tb_quotation insertion');
            }
            ...
            // Prepare statement failed
            redirect('quote-jkr-create.php', 'Error preparing tb_quotation statement');
        }
    } else {
        redirect('quote-jkr-create.php', 'Please fill all the input fields');
    }
}
