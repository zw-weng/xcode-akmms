    ...
    <div class="pagetitle">
      ...
      <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="btn-group me-2">
          <a href="staff-customeradd1.php" class="btn btn-primary shadow"><i class="bi bi-plus-circle"></i> Add</a>
                ...
                <table class="table datatable table-hover">
                  ...
                  <tbody>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      echo "<a href='staff-customeredit1.php?id=" . $row['cust_id'] . "' class='btn btn-warning btn-sm' title='Edit'><i class='bi bi-pencil'></i></a>";
                      echo "&nbsp;";
                      ...
                      echo "<a class='dropdown-item text-success' href='staff-customeractivate.php?id=" . $row['cust_id'] . "&action=activate' onclick='return confirm(\"Are you sure you want to activate this customer?\")'><i class='bi bi-check-circle'></i> Activate</a>";
                      echo "<a class='dropdown-item text-danger' href='staff-customerdeactivate.php?id=" . $row['cust_id'] . "&action=deactivate' onclick='return confirm(\"Are you sure you want to deactivate this customer?\")'><i class='bi bi-x-circle'></i> Deactivate</a>";
                      echo "</div>";
                      echo "</div>";
                      echo "</td>";
                      echo "</tr>";
