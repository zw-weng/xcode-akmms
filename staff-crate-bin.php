                ...
                <tbody>
                  ...
                  while ($rowc = mysqli_fetch_array($resultc)) {
                    if ($rowc['c_status'] == 0) {
                      ...
                      echo "<a class='btn btn-success btn-sm' href='staff-crate-activate.php?id=" . $rowc['c_id'] . "&action=activate' onclick='return confirm(\"Are you sure you want to restore this data?\")'><i class='bi bi-arrow-counterclockwise'></i> Restore</a>";
                      echo "</div>";
                      echo "</td>";
                      echo "</tr>";
                    }
